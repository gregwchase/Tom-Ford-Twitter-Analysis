...
**Disclaimer: Please note that I am not employed by Tom Ford International. This project was taken on due to personal interest in the brand.**
...
3. Since the size of the word relates to frequency of occurence, something noticeable in the word cloud is the word "nocturnalanimals" (just below "auction"). While this may look out of place, this is in reference to the film "Nocturnal Animals", which is directed by Tom Ford. At the time of this project, the film is set to debut on November 23, 2016. This suggests people are talking about the film on Twitter, and using the hashtag "#tomford" when tweeting about the film itself.
